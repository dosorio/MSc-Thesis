...
\end{center}
\end{frame}
\begin{frame}{Gene Expression Integration Available Algorithms}
\begin{center}
\begin{tabular}{r|c|p{3.7cm}}
\hline
\textbf{ALGORITHM}&\textbf{ENVIRONMENT}&\textbf{HOW IT WORKS}\\
\hline
\hline
\multirow{2}{*}{GIMME}&\multirow{2}{*}{MatLab - \textbf{Privative}}&· \textbf{Binary Disctretization}\\
&&· \textbf{Incorporation associated to a selected objective function}\\
\hline
\multirow{2}{*}{iMAT}&\multirow{2}{*}{MatLab - \textbf{Privative}}&· \\
&&· \\
\hline
\multirow{2}{*}{E-FLUX}&\multirow{2}{*}{\textbf{Not implemented}}&·\\
&&·.\\
\hline
\multirow{2}{*}{PROM}&\multirow{2}{*}{MatLab - \textbf{Privative}}&·\\
&&·\\
\hline
\end{tabular}
\end{center}
