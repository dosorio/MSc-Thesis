...
\end{beamercolorbox}%
\begin{beamercolorbox}[wd=.05\paperwidth,ht=2.5ex,dp=1.125ex,leftskip=.1cm,rightskip=.1cm plus1fil]{mycolor}%
...
\begin{frame}
\begin{multicols}{2}
\includegraphics[height=1cm]{logoIG}
\begin{flushright}
\includegraphics[height=1cm]{logoGIBBS}
\end{flushright}
\end{multicols}
\begin{center}
