...
\end{center}
\textcolor{blue}{\textcircled{{\tiny 1}}} {\tiny \vspace{0.3cm}\\}\pause
\textcolor{blue}{\textcircled{{\tiny 2}}} {\tiny \vspace{0.3cm}\\}\pause
\textcolor{blue}{\textcircled{{\tiny 3}}} {\tiny \vspace{0.3cm}\\}\pause
\end{frame}
\begin{frame}{Gliotransmitters}
...
\end{center}
\end{frame}
\begin{frame}{This work was presented as a set of four manuscripts}
\begin{footnotesize}
\begin{description}
