...
\pause
\begin{center}
\fcolorbox{red}{red}{\textcolor{white}{\strut $\blacktriangle$ Endoplasmic reticulum stress}} $\rightarrow$ \fcolorbox{red}{red}{\textcolor{white}{\strut $\blacktriangle$ UPR}}
\end{center}
\begin{center}
\fcolorbox{red}{red}{\strut \textcolor{white}{$\blacktriangle$ Reactive C Protein Ligands}}  + \fcolorbox{red}{red}{\strut \textcolor{white}{$\blacktriangle$ TNF$\alpha$}} + \fcolorbox{red}{red}{\strut \textcolor{white}{$\blacktriangle$ IL6}} + \fcolorbox{red}{red}{\strut \textcolor{white}{$\blacktriangle$ ROS}} 
\end{center}
\end{frame}
...
\end{center}
\begin{center}
\fcolorbox{red}{red}{\strut \textcolor{white}{\textbf{ROS} generator}} \pause
\fcolorbox{red}{red}{\strut \textcolor{white}{\textbf{Mitochondrial Failure}}} \pause
\fcolorbox{red}{red}{\strut \textcolor{white}{\textbf{Ca$^{+2}$} disregulation}} \pause\\
